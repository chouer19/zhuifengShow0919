// Generated by gencpp from file zfmsg/CanInfoAW.msg
// DO NOT EDIT!


#ifndef ZFMSG_MESSAGE_CANINFOAW_H
#define ZFMSG_MESSAGE_CANINFOAW_H
...
struct CanInfoAW_
{
  typedef CanInfoAW_<ContainerAllocator> Type;
  ...
  CanInfoAW_(const ContainerAllocator& _alloc)
    : header(_alloc)
    , tm(_alloc)
    , devmode(0)
    , drvcontmode(0)
  ...
  typedef boost::shared_ptr< ::zfmsg::CanInfoAW_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::zfmsg::CanInfoAW_<ContainerAllocator> const> ConstPtr;

}; // struct CanInfoAW_

typedef ::zfmsg::CanInfoAW_<std::allocator<void> > CanInfoAW;

typedef boost::shared_ptr< ::zfmsg::CanInfoAW > CanInfoAWPtr;
typedef boost::shared_ptr< ::zfmsg::CanInfoAW const> CanInfoAWConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::zfmsg::CanInfoAW_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::zfmsg::CanInfoAW_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::zfmsg::CanInfoAW_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::zfmsg::CanInfoAW_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::zfmsg::CanInfoAW_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::zfmsg::CanInfoAW_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::zfmsg::CanInfoAW_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::zfmsg::CanInfoAW_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::zfmsg::CanInfoAW_<ContainerAllocator> >
{
  ...
  static const char* value(const ::zfmsg::CanInfoAW_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x605f4356821f92a8ULL;
  static const uint64_t static_value2 = 0xfec1a756259316dfULL;
};

template<class ContainerAllocator>
struct DataType< ::zfmsg::CanInfoAW_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::zfmsg::CanInfoAW_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::zfmsg::CanInfoAW_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::zfmsg::CanInfoAW_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::zfmsg::CanInfoAW_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // ZFMSG_MESSAGE_CANINFOAW_H
