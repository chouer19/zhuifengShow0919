...
class MotionCmd {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('breakPressure')) {
        this.breakPressure = initObj.breakPressure
      }
      else {
        this.breakPressure = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [breakPressure]
    bufferOffset = _serializer.float32(obj.breakPressure, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [breakPressure]
    data.breakPressure = _deserializer.float32(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MotionCmd(null);
    ...
    if (msg.breakPressure !== undefined) {
      resolved.breakPressure = msg.breakPressure;
    }
    else {
      resolved.breakPressure = 0.0
    }
